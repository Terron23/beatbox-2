...
const StudioSearchTemplate =({studioName, _id, studioImage, price, guest, studioType, city, availibility})=>(
    <div className="single-room-area d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="100ms">
...
<h6>Hours of Operation: {availibility.map(hours=>(<li>
    ...
    {}
        ...
        <Link to={`/single-studio/${_id}`} className="btn view-detail-btn">View Details <i className="fa fa-long-arrow-right" aria-hidden="true"></i></Link>
    </div>
    </div>)
