...
<div>
    ...
    <ul>
        <li><i className="fa fa-check"></i> Mauris molestie lectus in irdiet auctor.</li>
        <li><i className="fa fa-check"></i> Dictum purus at blandit molestie.</li>
        <li><i className="fa fa-check"></i> Neque non fermentum suscipit.</li>
        <li><i className="fa fa-check"></i> Donec id dui ac massa malesuada.</li>
        <li><i className="fa fa-check"></i> In sit amet sapien quis orci maximus.</li>
        <li><i className="fa fa-check"></i> Vestibulum rutrum diam vel eros tristique.</li>
    </ul>
